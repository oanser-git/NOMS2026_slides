...
\begin{tikzpicture}[font=\sffamily\scriptsize,line width=0.58pt]
    ...
    % Step 1: choose one attack common to both years.
    \visible<1->{
    ...
    \visible<2->{
        \node[panel=sourceviolet,minimum width=4.05cm,minimum height=1.96cm,anchor=north west] at (0.38,5.45) {};
        \node[panel=targetorange,minimum width=4.05cm,minimum height=1.96cm,anchor=north west] at (5.77,5.45) {};

        \node[font=\bfseries\scriptsize,text=sourceviolet!78!black] at (2.40,5.17) {IDS2017 source};
        \node[font=\bfseries\scriptsize,text=targetorange!78!black] at (7.80,5.17) {IDS2018 target};

        \node[chip=sourceviolet] (d17) at (2.40,4.62) {$\mathcal{D}^{2017}_{a_k}$};
        \node[chip=targetorange] (d18) at (7.80,4.62) {$\mathcal{D}^{2018}_{a_k}$};

        \node[smallchip=sourceviolet] at (1.45,3.94) {2017 attack \(a_k\)};
        \node[smallchip=benigngray] (b17) at (3.25,3.94) {benign \(B\)};
        \node[smallchip=targetorange] at (6.85,3.94) {2018 attack \(a_k\)};
        \node[smallchip=benigngray] (b18) at (8.65,3.94) {benign \(B\)};

        \node[font=\bfseries\Large,text=black!45] at (5.10,6.32) {$+$};
        \node[draw=benigngray!28,fill=benigngray!6,rounded corners=5pt,minimum width=4.45cm,minimum height=0.52cm]
            (benignnote) at (5.45,5.72) {};
        \node[align=left,font=\tiny,text=benigngray!72!black]
            at (4.80,5.72) {shared benign background\\sampled once from IDS2017};
        \node[smallchip=benigngray] at (6.70,5.72) {benign \(B\)};

        \draw[->,draw=black!60,line width=0.95pt] (4.56,4.62) -- node[above,font=\tiny,text=black!58] {year / topology / volume change} (5.62,4.62);
    }
    ...
    \visible<4->{
        ...
        \node[font=\bfseries\scriptsize,text=black!72] at (6.55,1.36) {evaluate on \(\mathcal{D}^{2018}_{a_k}\)};
